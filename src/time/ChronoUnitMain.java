...
public class ChronoUnitMain {
    public static void main(String[] args) {
        ...
        System.out.println("secounsBetween = " + secondsBetween);

        long minutesBeteween = ChronoUnit.MINUTES.between(lt1, lt2);
        System.out.println("minutesBeteween = " + minutesBeteween);
